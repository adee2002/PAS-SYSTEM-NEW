        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdentityRevealedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Machine Learning, Deep Learning, NLP", "Artificial Intelligence" },
                    { 2, "Frontend, Backend, Full Stack", "Web Development" },
                    { 3, "Network Security, Cryptography", "Cybersecurity" },
                    { 4, "AWS, Azure, DevOps", "Cloud Computing" },
                    { 5, "iOS, Android, Cross-platform", "Mobile Development" },
                    { 6, "Big Data, Analytics, Visualization", "Data Science" }
                });
